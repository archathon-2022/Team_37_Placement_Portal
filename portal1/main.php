...
<div class="container">
	...
	<a href="stulogin.php" class="btn btn-info" role="button"> Student Login</a>&nbsp&nbsp<a href="Adminlogin.php" class="btn btn-info" role="button">Admin Login</a>&nbsp&nbsp<a href="companylogin.php"  class="btn btn-info" role="button">company Login</a>&nbsp&nbsp&nbsp&nbsp
	</div>
	<?php
