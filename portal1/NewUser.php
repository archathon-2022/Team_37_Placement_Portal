...
<table align="center" border="1" width="70%">
	...
	<td><input type="radio" name="userType" value="admin"> Admin<input type="radio" name="userType" value="student">Student<input type="radio" name="userType" value="company">Company
